...
public class AspNetCore9PreCheck : PreCheckBase
{
    ...
    public override async Task<PreCheckResult> CheckOperation()
    {
        ...
        const string failedButtonText = "Download Asp.Net Core 9 Desktop Runtime";
        ...
        var failedButtonAction = () =>
        {
            Process.Start(new ProcessStartInfo
            {
                ...
                {
                    "/C", "start",
                    "https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-aspnetcore-9.0.10-windows-x64-installer"
                }
            });
        };
